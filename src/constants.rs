...
pub const B_BUFFER_OVERFLOW: c_int = EOVERFLOW;
...
pub const B_DEVICE_NOT_FOUND: c_int = ENODEV;
...
pub const B_FILE_TOO_LARGE: c_int = EFBIG;
...
pub const B_NOT_SUPPORTED: c_int = EOPNOTSUPP;
...
pub const B_POSIX_ENOMEM: c_int = (B_POSIX_ERROR_BASE + 0);
...
pub const B_RESULT_NOT_REPRESENTABLE: c_int = ERANGE;
...
pub const B_TOO_MANY_ARGS: c_int = E2BIG;
...
pub const E2BIG: c_int = (B_POSIX_ERROR_BASE + 1);
pub const EACCES: c_int = (B_PERMISSION_DENIED);
pub const EADDRINUSE: c_int = (B_POSIX_ERROR_BASE + 22);
pub const EADDRNOTAVAIL: c_int = (B_POSIX_ERROR_BASE + 23);
pub const EAFNOSUPPORT: c_int = (B_POSIX_ERROR_BASE + 21);
pub const EAGAIN: c_int = (B_WOULD_BLOCK)	/* SysV compatibility */;
pub const EALREADY: c_int = (B_POSIX_ERROR_BASE + 37);
pub const EBADF: c_int = (B_FILE_ERROR);
pub const EBADMSG: c_int = (B_POSIX_ERROR_BASE + 46);
pub const EBUSY: c_int = (B_BUSY);
pub const ECANCELED: c_int = (B_POSIX_ERROR_BASE + 47);
pub const ECHILD: c_int = (B_POSIX_ERROR_BASE + 2);
pub const ECONNABORTED: c_int = (B_POSIX_ERROR_BASE + 27);
pub const ECONNREFUSED: c_int = (B_POSIX_ERROR_BASE + 32);
pub const ECONNRESET: c_int = (B_POSIX_ERROR_BASE + 28);
pub const EDEADLK: c_int = (B_POSIX_ERROR_BASE + 3);
pub const EDESTADDRREQ: c_int = (B_POSIX_ERROR_BASE + 48);
pub const EDOM: c_int = (B_POSIX_ERROR_BASE + 16);
pub const EDQUOT: c_int = (B_POSIX_ERROR_BASE + 49);
pub const EEXIST: c_int = (B_FILE_EXISTS);
pub const EFAULT: c_int = (B_BAD_ADDRESS);
pub const EFBIG: c_int = (B_POSIX_ERROR_BASE + 4);
pub const EFPOS: c_int = (B_POSIX_ERROR_BASE + 14);
pub const EHOSTDOWN: c_int = (B_POSIX_ERROR_BASE + 45);
pub const EHOSTUNREACH: c_int = (B_POSIX_ERROR_BASE + 33);
pub const EIDRM: c_int = (B_POSIX_ERROR_BASE + 50);
pub const EILSEQ: c_int = (B_POSIX_ERROR_BASE + 38);
pub const EINPROGRESS: c_int = (B_POSIX_ERROR_BASE + 36);
pub const EINTR: c_int = (B_INTERRUPTED);
pub const EINVAL: c_int = (B_BAD_VALUE);
pub const EIO: c_int = (B_IO_ERROR);
pub const EISCONN: c_int = (B_POSIX_ERROR_BASE + 29);
pub const EISDIR: c_int = (B_IS_A_DIRECTORY);
pub const ELOOP: c_int = (B_LINK_LIMIT);
pub const EMFILE: c_int = (B_NO_MORE_FDS);
pub const EMLINK: c_int = (B_POSIX_ERROR_BASE + 5);
pub const EMSGSIZE: c_int = (B_POSIX_ERROR_BASE + 42);
pub const EMULTIHOP: c_int = (B_POSIX_ERROR_BASE + 51);
pub const ENAMETOOLONG: c_int = (B_NAME_TOO_LONG);
pub const ENETDOWN: c_int = (B_POSIX_ERROR_BASE + 24);
pub const ENETRESET: c_int = (B_POSIX_ERROR_BASE + 26);
pub const ENETUNREACH: c_int = (B_POSIX_ERROR_BASE + 25);
pub const ENFILE: c_int = (B_POSIX_ERROR_BASE + 6);
pub const ENOATTR: c_int = (B_POSIX_ERROR_BASE + 60);
pub const ENOBUFS: c_int = (B_POSIX_ERROR_BASE + 35);
pub const ENODATA: c_int = (B_POSIX_ERROR_BASE + 52);
pub const ENODEV: c_int = (B_POSIX_ERROR_BASE + 7);
pub const ENOENT: c_int = (B_ENTRY_NOT_FOUND);
pub const ENOEXEC: c_int = (B_NOT_AN_EXECUTABLE);
pub const ENOLCK: c_int = (B_POSIX_ERROR_BASE + 8);
pub const ENOLINK: c_int = (B_POSIX_ERROR_BASE + 53);
pub const ENOMEM: c_int = B_NO_MEMORY;
pub const ENOMSG: c_int = (B_POSIX_ERROR_BASE + 39);
pub const ENOPROTOOPT: c_int = (B_POSIX_ERROR_BASE + 34);
pub const ENOSPC: c_int = (B_DEVICE_FULL);
pub const ENOSR: c_int = (B_POSIX_ERROR_BASE + 54);
pub const ENOSTR: c_int = (B_POSIX_ERROR_BASE + 55);
pub const ENOSYS: c_int = (B_POSIX_ERROR_BASE + 9);
pub const ENOTCONN: c_int = (B_POSIX_ERROR_BASE + 30);
pub const ENOTDIR: c_int = (B_NOT_A_DIRECTORY);
pub const ENOTEMPTY: c_int = (B_DIRECTORY_NOT_EMPTY);
pub const ENOTRECOVERABLE: c_int = (B_POSIX_ERROR_BASE + 61);
pub const ENOTSOCK: c_int = (B_POSIX_ERROR_BASE + 44);
pub const ENOTSUP: c_int = (B_POSIX_ERROR_BASE + 56);
pub const ENOTTY: c_int = (B_POSIX_ERROR_BASE + 10);
pub const ENXIO: c_int = (B_POSIX_ERROR_BASE + 11);
pub const EOPNOTSUPP: c_int = (B_POSIX_ERROR_BASE + 43);
pub const EOVERFLOW: c_int = (B_POSIX_ERROR_BASE + 41);
pub const EOWNERDEAD: c_int = (B_POSIX_ERROR_BASE + 62);
pub const EPERM: c_int = (B_NOT_ALLOWED);
pub const EPFNOSUPPORT: c_int = (B_POSIX_ERROR_BASE + 20);
pub const EPIPE: c_int = (B_BUSTED_PIPE);
pub const EPROTO: c_int = (B_POSIX_ERROR_BASE + 57);
pub const EPROTONOSUPPORT: c_int = (B_POSIX_ERROR_BASE + 19);
pub const EPROTOTYPE: c_int = (B_POSIX_ERROR_BASE + 18);
pub const ERANGE: c_int = (B_POSIX_ERROR_BASE + 17);
pub const EROFS: c_int = (B_READ_ONLY_DEVICE);
pub const ESHUTDOWN: c_int = (B_POSIX_ERROR_BASE + 31);
pub const ESIGPARM: c_int = (B_POSIX_ERROR_BASE + 15);
pub const ESPIPE: c_int = (B_POSIX_ERROR_BASE + 12);
pub const ESRCH: c_int = (B_POSIX_ERROR_BASE + 13);
pub const ESTALE: c_int = (B_POSIX_ERROR_BASE + 40);
pub const ETIME: c_int = (B_POSIX_ERROR_BASE + 58);
pub const ETIMEDOUT: c_int = (B_TIMED_OUT);
pub const ETXTBSY: c_int = (B_POSIX_ERROR_BASE + 59);
pub const EWOULDBLOCK: c_int = (B_WOULD_BLOCK)	/* BSD compatibility */;
pub const EXDEV: c_int = (B_CROSS_DEVICE_LINK);

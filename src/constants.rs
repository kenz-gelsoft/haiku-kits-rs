...
//  ENUM: @81
pub const HttpStatus: char = '_HST';
pub const HttpFields: char = '_HHF';
pub const CertificateError: char = '_CER';
pub const HttpRedirect: char = '_HRE';
//  ENUM: @82
pub const HostNameResolved: char = '_NHR';
pub const ConnectionOpened: char = '_NCO';
pub const UploadProgress: char = '_NUP';
pub const ResponseStarted: char = '_NRS';
pub const DownloadProgress: char = '_NDP';
pub const BytesWritten: char = '_NBW';
pub const RequestCompleted: char = '_NRC';
pub const DebugMessage: char = '_NDB';

//  ENUM: @83
pub const DebugInfo: char = '_DBI';
pub const DebugWarning: char = '_DBW';
pub const DebugError: char = '_DBE';
...
//  ENUM: @0
pub const B_ABOUT_REQUESTED: char = '_ABR';
pub const B_WINDOW_ACTIVATED: char = '_ACT';
pub const B_APP_ACTIVATED: char = '_ACT';
pub const B_ARGV_RECEIVED: char = '_ARG';
pub const B_QUIT_REQUESTED: char = '_QRQ';
pub const B_CLOSE_REQUESTED: char = '_QRQ';
pub const B_CANCEL: char = '_CNC';
pub const B_INVALIDATE: char = '_IVL';
pub const B_KEY_DOWN: char = '_KYD';
pub const B_KEY_UP: char = '_KYU';
pub const B_UNMAPPED_KEY_DOWN: char = '_UKD';
pub const B_UNMAPPED_KEY_UP: char = '_UKU';
pub const B_KEY_MAP_LOADED: char = '_KML';
pub const B_LAYOUT_WINDOW: char = '_LAY';
pub const B_MODIFIERS_CHANGED: char = '_MCH';
pub const B_MINIMIZE: char = '_WMN';
pub const B_MOUSE_DOWN: char = '_MDN';
pub const B_MOUSE_MOVED: char = '_MMV';
pub const B_MOUSE_ENTER_EXIT: char = '_MEX';
pub const B_MOUSE_IDLE: char = '_MSI';
pub const B_MOUSE_UP: char = '_MUP';
pub const B_MOUSE_WHEEL_CHANGED: char = '_MWC';
pub const B_OPEN_IN_WORKSPACE: char = '_OWS';
pub const B_PACKAGE_UPDATE: char = '_PKU';
pub const B_PRINTER_CHANGED: char = '_PCH';
pub const B_PULSE: char = '_PUL';
pub const B_READY_TO_RUN: char = '_RTR';
pub const B_REFS_RECEIVED: char = '_RRC';
pub const B_RELEASE_OVERLAY_LOCK: char = '_ROV';
pub const B_ACQUIRE_OVERLAY_LOCK: char = '_AOV';
pub const B_SCREEN_CHANGED: char = '_SCH';
pub const B_VALUE_CHANGED: char = '_VCH';
pub const B_TRANSLATOR_ADDED: char = '_ART';
pub const B_TRANSLATOR_REMOVED: char = '_RRT';
pub const B_DELETE_TRANSLATOR: char = '_DRT';
pub const B_VIEW_MOVED: char = '_VMV';
pub const B_VIEW_RESIZED: char = '_VRS';
pub const B_WINDOW_MOVED: char = '_WMV';
pub const B_WINDOW_RESIZED: char = '_WRS';
pub const B_WORKSPACES_CHANGED: char = '_WCG';
pub const B_WORKSPACE_ACTIVATED: char = '_WAC';
pub const B_ZOOM: char = '_WZM';
pub const B_COLORS_UPDATED: char = '_CLU';
pub const B_FONTS_UPDATED: char = '_FNU';
pub const B_TRACKER_ADDON_MESSAGE: char = '_TAM';
pub const _APP_MENU_: char = '_AMN';
pub const _BROWSER_MENUS_: char = '_BRM';
pub const _MENU_EVENT_: char = '_MEV';
pub const _PING_: char = '_PBL';
pub const _QUIT_: char = '_QIT';
pub const _VOLUME_MOUNTED_: char = '_NVL';
pub const _VOLUME_UNMOUNTED_: char = '_VRM';
pub const _MESSAGE_DROPPED_: char = '_MDP';
pub const _DISPOSE_DRAG_: char = '_DPD';
pub const _MENUS_DONE_: char = '_MND';
pub const _SHOW_DRAG_HANDLES_: char = '_SDH';
pub const _EVENTS_PENDING_: char = '_EVP';
pub const _UPDATE_: char = '_UPD';
pub const _UPDATE_IF_NEEDED_: char = '_UPN';
pub const _PRINTER_INFO_: char = '_PIN';
pub const _SETUP_PRINTER_: char = '_SUP';
pub const _SELECT_PRINTER_: char = '_PSL';
//  ENUM: @1
pub const B_SET_PROPERTY: char = 'PSET';
pub const B_GET_PROPERTY: char = 'PGET';
pub const B_CREATE_PROPERTY: char = 'PCRT';
pub const B_DELETE_PROPERTY: char = 'PDEL';
pub const B_COUNT_PROPERTIES: char = 'PCNT';
pub const B_EXECUTE_PROPERTY: char = 'PEXE';
pub const B_GET_SUPPORTED_SUITES: char = 'SUIT';
pub const B_UNDO: char = 'UNDO';
pub const B_REDO: char = 'REDO';
pub const B_CUT: char = 'CCUT';
pub const B_COPY: char = 'COPY';
pub const B_PASTE: char = 'PSTE';
pub const B_SELECT_ALL: char = 'SALL';
pub const B_SAVE_REQUESTED: char = 'SAVE';
pub const B_MESSAGE_NOT_UNDERSTOOD: char = 'MNOT';
pub const B_NO_REPLY: char = 'NONE';
pub const B_REPLY: char = 'RPLY';
pub const B_SIMPLE_DATA: char = 'DATA';
pub const B_MIME_DATA: char = 'MIME';
pub const B_ARCHIVED_OBJECT: char = 'ARCV';
pub const B_UPDATE_STATUS_BAR: char = 'SBUP';
pub const B_RESET_STATUS_BAR: char = 'SBRS';
pub const B_NODE_MONITOR: char = 'NDMN';
pub const B_QUERY_UPDATE: char = 'QUPD';
pub const B_ENDORSABLE: char = 'ENDO';
pub const B_COPY_TARGET: char = 'DDCP';
pub const B_MOVE_TARGET: char = 'DDMV';
pub const B_TRASH_TARGET: char = 'DDRM';
pub const B_LINK_TARGET: char = 'DDLN';
pub const B_INPUT_DEVICES_CHANGED: char = 'IDCH';
pub const B_INPUT_METHOD_EVENT: char = 'IMEV';
pub const B_WINDOW_MOVE_TO: char = 'WDMT';
pub const B_WINDOW_MOVE_BY: char = 'WDMB';
pub const B_SILENT_RELAUNCH: char = 'AREL';
pub const B_OBSERVER_NOTICE_CHANGE: char = 'NTCH';
pub const B_CONTROL_INVOKED: char = 'CIVK';
pub const B_CONTROL_MODIFIED: char = 'CMOD';

//  ENUM: @2
pub const B_CLIPBOARD_CHANGED: char = 'CLCH';
...
//  ENUM: @6
pub const B_SOME_APP_LAUNCHED: char = 'BRAS';
pub const B_SOME_APP_QUIT: char = 'BRAQ';
pub const B_SOME_APP_ACTIVATED: char = 'BRAW';
...
//  ENUM: @40
pub const B_OPTION_CONTROL_VALUE: char = '_BMV';
...
//  ENUM: @53
pub const B_LOCALE_CHANGED: char = '_LCC';
...
//  ENUM: @54
pub const B_MAIL_BODY_FETCHED: char = '_Mbf';
...
//  ENUM: @58
pub const B_MEDIA_WILDCARD: char = 'TRWC';
pub const B_MEDIA_NODE_CREATED: char = 'TRIA';
pub const B_MEDIA_NODE_DELETED: char = 'TRIA' + 1;
pub const B_MEDIA_CONNECTION_MADE: char = 'TRIA' + 2;
pub const B_MEDIA_CONNECTION_BROKEN: char = 'TRIA' + 3;
pub const B_MEDIA_BUFFER_CREATED: char = 'TRIA' + 4;
pub const B_MEDIA_BUFFER_DELETED: char = 'TRIA' + 5;
pub const B_MEDIA_TRANSPORT_STATE: char = 'TRIA' + 6;
pub const B_MEDIA_PARAMETER_CHANGED: char = 'TRIA' + 7;
pub const B_MEDIA_FORMAT_CHANGED: char = 'TRIA' + 8;
pub const B_MEDIA_WEB_CHANGED: char = 'TRIA' + 9;
pub const B_MEDIA_DEFAULT_CHANGED: char = 'TRIA' + 10;
pub const B_MEDIA_NEW_PARAMETER_VALUE: char = 'TRIA' + 11;
pub const B_MEDIA_NODE_STOPPED: char = 'TRIA' + 12;
pub const B_MEDIA_FLAVORS_CHANGED: char = 'TRIA' + 13;
pub const B_MEDIA_SERVER_STARTED: char = 'TRIA' + 14;
pub const B_MEDIA_SERVER_QUIT: char = 'TRIA' + 15;
//  ENUM: @59
...
//  ENUM: beos_format
pub const B_BEOS_FORMAT_RAW_AUDIO: char = 'rawa';
pub const B_BEOS_FORMAT_RAW_VIDEO: char = 'rawv';
...
pub const B_MIDI_EVENT: char = 'MIDI';
//  ENUM: BMidiOp
...
pub const B_NETWORK_MONITOR: char = '_NTN';
...
//  ENUM: @94
pub const B_META_MIME_CHANGED: char = 'MMCH';
//  ENUM: @95
...
//  ENUM: @96
pub const B_META_MIME_MODIFIED: char = 'MMMD';
pub const B_META_MIME_DELETED: char = 'MMDL';
//  ENUM: app_verb
...
pub const B_ERASE_FILE: char = O_TRUNC		/* erase the file's data */;
...
//  ENUM: @101
pub const B_AFFINE_TRANSFORM_TYPE: char = 'AMTX';
pub const B_ALIGNMENT_TYPE: char = 'ALGN';
pub const B_ANY_TYPE: char = 'ANYT';
pub const B_ATOM_TYPE: char = 'ATOM';
pub const B_ATOMREF_TYPE: char = 'ATMR';
pub const B_BOOL_TYPE: char = 'BOOL';
pub const B_CHAR_TYPE: char = 'CHAR';
pub const B_COLOR_8_BIT_TYPE: char = 'CLRB';
pub const B_DOUBLE_TYPE: char = 'DBLE';
pub const B_FLOAT_TYPE: char = 'FLOT';
pub const B_GRAYSCALE_8_BIT_TYPE: char = 'GRYB';
pub const B_INT16_TYPE: char = 'SHRT';
pub const B_INT32_TYPE: char = 'LONG';
pub const B_INT64_TYPE: char = 'LLNG';
pub const B_INT8_TYPE: char = 'BYTE';
pub const B_LARGE_ICON_TYPE: char = 'ICON';
pub const B_MEDIA_PARAMETER_GROUP_TYPE: char = 'BMCG';
pub const B_MEDIA_PARAMETER_TYPE: char = 'BMCT';
pub const B_MEDIA_PARAMETER_WEB_TYPE: char = 'BMCW';
pub const B_MESSAGE_TYPE: char = 'MSGG';
pub const B_MESSENGER_TYPE: char = 'MSNG';
pub const B_MIME_TYPE: char = 'MIME';
pub const B_MINI_ICON_TYPE: char = 'MICN';
pub const B_MONOCHROME_1_BIT_TYPE: char = 'MNOB';
pub const B_OBJECT_TYPE: char = 'OPTR';
pub const B_OFF_T_TYPE: char = 'OFFT';
pub const B_PATTERN_TYPE: char = 'PATN';
pub const B_POINTER_TYPE: char = 'PNTR';
pub const B_POINT_TYPE: char = 'BPNT';
pub const B_PROPERTY_INFO_TYPE: char = 'SCTD';
pub const B_RAW_TYPE: char = 'RAWT';
pub const B_RECT_TYPE: char = 'RECT';
pub const B_REF_TYPE: char = 'RREF';
pub const B_NODE_REF_TYPE: char = 'NREF';
pub const B_RGB_32_BIT_TYPE: char = 'RGBB';
pub const B_RGB_COLOR_TYPE: char = 'RGBC';
pub const B_SIZE_TYPE: char = 'SIZE';
pub const B_SIZE_T_TYPE: char = 'SIZT';
pub const B_SSIZE_T_TYPE: char = 'SSZT';
pub const B_STRING_TYPE: char = 'CSTR';
pub const B_STRING_LIST_TYPE: char = 'STRL';
pub const B_TIME_TYPE: char = 'TIME';
pub const B_UINT16_TYPE: char = 'USHT';
pub const B_UINT32_TYPE: char = 'ULNG';
pub const B_UINT64_TYPE: char = 'ULLG';
pub const B_UINT8_TYPE: char = 'UBYT';
pub const B_VECTOR_ICON_TYPE: char = 'VICN';
pub const B_XATTR_TYPE: char = 'XATR';
pub const B_NETWORK_ADDRESS_TYPE: char = 'NWAD';
pub const B_MIME_STRING_TYPE: char = 'MIMS';
pub const B_ASCII_TYPE: char = 'TEXT';
...
//  ENUM: @104
pub const B_GIF_FORMAT: char = 'GIF ';
pub const B_JPEG_FORMAT: char = 'JPEG';
pub const B_PNG_FORMAT: char = 'PNG ';
pub const B_PPM_FORMAT: char = 'PPM ';
pub const B_TGA_FORMAT: char = 'TGA ';
pub const B_BMP_FORMAT: char = 'BMP ';
pub const B_TIFF_FORMAT: char = 'TIFF';
pub const B_WEBP_FORMAT: char = 'WebP';
pub const B_DXF_FORMAT: char = 'DXF ';
pub const B_EPS_FORMAT: char = 'EPS ';
pub const B_PICT_FORMAT: char = 'PICT';
pub const B_WAV_FORMAT: char = 'WAV ';
pub const B_AIFF_FORMAT: char = 'AIFF';
pub const B_CD_FORMAT: char = 'CD  ';
pub const B_AU_FORMAT: char = 'AU  ';
pub const B_STYLED_TEXT_FORMAT: char = 'STXT';
//  ENUM: TranslatorGroups
pub const B_TRANSLATOR_BITMAP: char = 'bits';
pub const B_TRANSLATOR_PICTURE: char = 'pict';
pub const B_TRANSLATOR_SOUND: char = 'nois';
pub const B_TRANSLATOR_TEXT: char = 'TEXT';
pub const B_TRANSLATOR_MIDI: char = 'midi';
pub const B_TRANSLATOR_MEDIA: char = 'mhi!';
pub const B_TRANSLATOR_NONE: char = 'none';

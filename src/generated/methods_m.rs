...
pub trait MessageMethods: RustBindingMethods {
    ...
    fn rename(&self, old_entry: Option<&str>, new_entry: Option<&str>) -> status_t {
        unsafe {
    ...
    fn unflatten_str(&self, flat_buffer: Option<&str>) -> status_t {
        unsafe {
            let flat_buffer = match flat_buffer {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
            };
            let flat_buffer = match &flat_buffer {
    ...
    fn add_specifier_str(&self, property: Option<&str>) -> status_t {
        unsafe {
    ...
    fn add_specifier_str_int32(&self, property: Option<&str>, index: i32) -> status_t {
        unsafe {
            let property = match property {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn add_specifier_str_int32_int32(
        &self,
        property: Option<&str>,
        index: i32,
        range: i32,
    ...
    fn add_specifier_str_str(&self, property: Option<&str>, name: Option<&str>) -> status_t {
        unsafe {
            let property = match property {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn add_alignment(&self, name: Option<&str>, alignment: *const c_void) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn add_rect<R: RectMethods>(&self, name: Option<&str>, rect: &R) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn add_point<P: PointMethods>(&self, name: Option<&str>, point: &P) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn add_size<S: SizeMethods>(&self, name: Option<&str>, size: &S) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn add_string_str(&self, name: Option<&str>, string: Option<&str>) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn add_string_string(&self, name: Option<&str>, string: *const c_void) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn add_strings(&self, name: Option<&str>, list: *const c_void) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn add_int8(&self, name: Option<&str>, value: i8) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn add_u_int8(&self, name: Option<&str>, value: u8) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn add_int16(&self, name: Option<&str>, value: i16) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn add_u_int16(&self, name: Option<&str>, value: u16) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn add_int32(&self, name: Option<&str>, value: i32) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn add_u_int32(&self, name: Option<&str>, value: u32) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn add_int64(&self, name: Option<&str>, value: i64) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn add_u_int64(&self, name: Option<&str>, value: u64) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn add_bool(&self, name: Option<&str>, value: bool) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn add_float(&self, name: Option<&str>, value: c_float) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn add_double(&self, name: Option<&str>, value: c_double) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn add_pointer(&self, name: Option<&str>, pointer: *const c_void) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn add_ref(&self, name: Option<&str>, ref_: *const c_void) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn add_node_ref(&self, name: Option<&str>, ref_: *const c_void) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn add_message<M: MessageMethods>(&self, name: Option<&str>, message: Option<&M>) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn add_flat(&self, name: Option<&str>, object: *const c_void, count: i32) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn remove_data(&self, name: Option<&str>, index: i32) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn remove_name(&self, name: Option<&str>) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn find_alignment_alignment(&self, name: Option<&str>, alignment: *mut c_void) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn find_rect_rect<R: RectMethods>(&self, name: Option<&str>, rect: Option<&R>) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn find_point_point<P: PointMethods>(&self, name: Option<&str>, point: Option<&P>) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn find_size_size<S: SizeMethods>(&self, name: Option<&str>, size: Option<&S>) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn find_string_str(&self, name: Option<&str>, string: Option<&str>) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn find_string_string(&self, name: Option<&str>, string: *mut c_void) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn find_strings(&self, name: Option<&str>, list: *mut c_void) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn find_int8_int8(&self, name: Option<&str>, value: *mut c_void) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn find_int8_int32_int8(&self, name: Option<&str>, index: i32, value: *mut c_void) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn find_u_int8_uint8(&self, name: Option<&str>, value: *mut c_void) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn find_u_int8_int32(&self, name: Option<&str>, index: i32, value: *mut c_void) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn find_int16_int16(&self, name: Option<&str>, value: *mut c_void) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn find_u_int16_uint16(&self, name: Option<&str>, value: *mut c_void) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn find_u_int16_int32(&self, name: Option<&str>, index: i32, value: *mut c_void) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn find_int32(&self, name: Option<&str>, index: i32, value: *mut c_void) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn find_u_int32_uint32(&self, name: Option<&str>, value: *mut c_void) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn find_u_int32_int32(&self, name: Option<&str>, index: i32, value: *mut c_void) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn find_int64_int64(&self, name: Option<&str>, value: *mut c_void) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn find_u_int64_uint64(&self, name: Option<&str>, value: *mut c_void) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn find_u_int64_int32(&self, name: Option<&str>, index: i32, value: *mut c_void) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn find_bool_bool(&self, name: Option<&str>, value: *mut c_void) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn find_bool_int32_bool(&self, name: Option<&str>, index: i32, value: *mut c_void) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn find_float_float(&self, name: Option<&str>, value: *mut c_void) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn find_double_double(&self, name: Option<&str>, value: *mut c_void) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn find_color_rgb_color(&self, name: Option<&str>, value: *mut c_void) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn find_color_int32(&self, name: Option<&str>, index: i32, value: *mut c_void) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn find_pointer_void(&self, name: Option<&str>, pointer: *mut c_void) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn find_pointer_int32(&self, name: Option<&str>, index: i32, pointer: *mut c_void) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn find_messenger_messenger(&self, name: Option<&str>, messenger: *mut c_void) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn find_ref_entry_ref(&self, name: Option<&str>, ref_: *mut c_void) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn find_ref_int32(&self, name: Option<&str>, index: i32, ref_: *mut c_void) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn find_node_ref_node_ref(&self, name: Option<&str>, ref_: *mut c_void) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn find_node_ref_int32(&self, name: Option<&str>, index: i32, ref_: *mut c_void) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn find_message_message<M: MessageMethods>(
        &self,
        name: Option<&str>,
        message: Option<&M>,
    ) -> status_t {
    ...
    fn find_flat_flattenable(&self, name: Option<&str>, object: *mut c_void) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn find_flat_int32(&self, name: Option<&str>, index: i32, object: *mut c_void) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn replace_alignment_alignment(
        &self,
        name: Option<&str>,
    ...
    fn replace_rect_rect<R: RectMethods>(&self, name: Option<&str>, rect: &R) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn replace_rect_int32<R: RectMethods>(
        &self,
        name: Option<&str>,
        index: i32,
        rect: &R,
    ...
    fn replace_point_point<P: PointMethods>(&self, name: Option<&str>, a_point: &P) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn replace_size_size<S: SizeMethods>(&self, name: Option<&str>, a_size: &S) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn replace_size_int32<S: SizeMethods>(
        &self,
        name: Option<&str>,
        index: i32,
        a_size: &S,
    ...
    fn replace_string_str(&self, name: Option<&str>, string: Option<&str>) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn replace_string_string(&self, name: Option<&str>, string: *const c_void) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn replace_int8_int8(&self, name: Option<&str>, value: i8) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn replace_int8_int32(&self, name: Option<&str>, index: i32, value: i8) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn replace_u_int8_uint8(&self, name: Option<&str>, value: u8) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn replace_u_int8_int32(&self, name: Option<&str>, index: i32, value: u8) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn replace_int16_int16(&self, name: Option<&str>, value: i16) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn replace_int16_int32(&self, name: Option<&str>, index: i32, value: i16) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn replace_u_int16_uint16(&self, name: Option<&str>, value: u16) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn replace_u_int16_int32(&self, name: Option<&str>, index: i32, value: u16) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn replace_int32(&self, name: Option<&str>, value: i32) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn replace_int32_int32(&self, name: Option<&str>, index: i32, value: i32) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn replace_u_int32_uint32(&self, name: Option<&str>, value: u32) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn replace_u_int32_int32(&self, name: Option<&str>, index: i32, value: u32) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn replace_int64_int64(&self, name: Option<&str>, value: i64) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn replace_int64_int32(&self, name: Option<&str>, index: i32, value: i64) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn replace_u_int64_uint64(&self, name: Option<&str>, value: u64) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn replace_u_int64_int32(&self, name: Option<&str>, index: i32, value: u64) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn replace_bool_bool(&self, name: Option<&str>, a_boolean: bool) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn replace_bool_int32(&self, name: Option<&str>, index: i32, value: bool) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn replace_float_float(&self, name: Option<&str>, value: c_float) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn replace_float_int32(&self, name: Option<&str>, index: i32, value: c_float) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn replace_double_double(&self, name: Option<&str>, value: c_double) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn replace_double_int32(&self, name: Option<&str>, index: i32, value: c_double) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn replace_pointer_void(&self, name: Option<&str>, pointer: *const c_void) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn replace_ref_entry_ref(&self, name: Option<&str>, ref_: *const c_void) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn replace_ref_int32(&self, name: Option<&str>, index: i32, ref_: *const c_void) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn replace_node_ref_node_ref(&self, name: Option<&str>, ref_: *const c_void) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn replace_flat_flattenable(&self, name: Option<&str>, object: *mut c_void) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn replace_flat_int32(&self, name: Option<&str>, index: i32, object: *mut c_void) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn has_alignment(&self, name: Option<&str>, n: i32) -> bool {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn has_rect(&self, name: Option<&str>, n: i32) -> bool {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn has_point(&self, name: Option<&str>, n: i32) -> bool {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn has_size(&self, name: Option<&str>, n: i32) -> bool {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn has_string(&self, name: Option<&str>, n: i32) -> bool {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn has_int8(&self, name: Option<&str>, n: i32) -> bool {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn has_u_int8(&self, name: Option<&str>, n: i32) -> bool {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn has_int16(&self, name: Option<&str>, n: i32) -> bool {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn has_u_int16(&self, name: Option<&str>, n: i32) -> bool {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn has_int32(&self, name: Option<&str>, n: i32) -> bool {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn has_u_int32(&self, name: Option<&str>, n: i32) -> bool {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn has_int64(&self, name: Option<&str>, n: i32) -> bool {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn has_u_int64(&self, name: Option<&str>, n: i32) -> bool {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn has_bool(&self, name: Option<&str>, n: i32) -> bool {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn has_float(&self, name: Option<&str>, n: i32) -> bool {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn has_double(&self, name: Option<&str>, n: i32) -> bool {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn has_color(&self, name: Option<&str>, n: i32) -> bool {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn has_pointer(&self, name: Option<&str>, n: i32) -> bool {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn has_messenger(&self, name: Option<&str>, n: i32) -> bool {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn has_ref(&self, name: Option<&str>, n: i32) -> bool {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn has_node_ref(&self, name: Option<&str>, n: i32) -> bool {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn has_message(&self, name: Option<&str>, n: i32) -> bool {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn has_flat_flattenable(&self, name: Option<&str>, object: *const c_void) -> bool {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn has_flat_int32(&self, name: Option<&str>, n: i32, object: *const c_void) -> bool {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn find_rect_int32(&self, name: Option<&str>, n: i32) -> Rect {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn find_point_int32(&self, name: Option<&str>, n: i32) -> Point {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn find_string_int32(&self, name: Option<&str>, n: i32) -> Option<&CStr> {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn find_int8_int32(&self, name: Option<&str>, n: i32) -> i8 {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn find_int16_int32(&self, name: Option<&str>, n: i32) -> i16 {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn find_int64_int32(&self, name: Option<&str>, n: i32) -> i64 {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn find_bool_int32(&self, name: Option<&str>, n: i32) -> bool {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn find_float_int32(&self, name: Option<&str>, n: i32) -> c_float {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn find_double_int32(&self, name: Option<&str>, n: i32) -> c_double {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn get_bool_bool(&self, name: Option<&str>, default_value: bool) -> bool {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn get_bool_int32(&self, name: Option<&str>, index: i32, default_value: bool) -> bool {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn get_int8_int8(&self, name: Option<&str>, default_value: i8) -> i8 {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn get_int8_int32(&self, name: Option<&str>, index: i32, default_value: i8) -> i8 {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn get_u_int8_uint8(&self, name: Option<&str>, default_value: u8) -> u8 {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn get_u_int8_int32(&self, name: Option<&str>, index: i32, default_value: u8) -> u8 {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn get_int16_int16(&self, name: Option<&str>, default_value: i16) -> i16 {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn get_int16_int32(&self, name: Option<&str>, index: i32, default_value: i16) -> i16 {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn get_u_int16_uint16(&self, name: Option<&str>, default_value: u16) -> u16 {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn get_u_int16_int32(&self, name: Option<&str>, index: i32, default_value: u16) -> u16 {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn get_int32(&self, name: Option<&str>, default_value: i32) -> i32 {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn get_int32_int32(&self, name: Option<&str>, index: i32, default_value: i32) -> i32 {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn get_u_int32_uint32(&self, name: Option<&str>, default_value: u32) -> u32 {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn get_u_int32_int32(&self, name: Option<&str>, index: i32, default_value: u32) -> u32 {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn get_int64_int64(&self, name: Option<&str>, default_value: i64) -> i64 {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn get_int64_int32(&self, name: Option<&str>, index: i32, default_value: i64) -> i64 {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn get_u_int64_uint64(&self, name: Option<&str>, default_value: u64) -> u64 {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn get_u_int64_int32(&self, name: Option<&str>, index: i32, default_value: u64) -> u64 {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn get_float_float(&self, name: Option<&str>, default_value: c_float) -> c_float {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn get_float_int32(&self, name: Option<&str>, index: i32, default_value: c_float) -> c_float {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn get_double_double(&self, name: Option<&str>, default_value: c_double) -> c_double {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn get_pointer_void(&self, name: Option<&str>, default_value: *const c_void) -> *const c_void {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn get_string_str(&self, name: Option<&str>, default_value: Option<&str>) -> Option<&CStr> {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn get_rect_int32<R: RectMethods>(
        &self,
        name: Option<&str>,
        index: i32,
        default_value: &R,
    ...
    fn get_rect_rect<R: RectMethods>(&self, name: Option<&str>, default_value: &R) -> Rect {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn get_point_int32<P: PointMethods>(
        &self,
        name: Option<&str>,
        index: i32,
        default_value: &P,
    ...
    fn get_point_point<P: PointMethods>(&self, name: Option<&str>, default_value: &P) -> Point {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn get_size_int32<S: SizeMethods>(
        &self,
        name: Option<&str>,
        index: i32,
        default_value: &S,
    ...
    fn get_size_size<S: SizeMethods>(&self, name: Option<&str>, default_value: &S) -> Size {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn set_bool(&self, name: Option<&str>, value: bool) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn set_int8(&self, name: Option<&str>, value: i8) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn set_u_int8(&self, name: Option<&str>, value: u8) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn set_int16(&self, name: Option<&str>, value: i16) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn set_u_int16(&self, name: Option<&str>, value: u16) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn set_int32(&self, name: Option<&str>, value: i32) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn set_u_int32(&self, name: Option<&str>, value: u32) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn set_int64(&self, name: Option<&str>, value: i64) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn set_u_int64(&self, name: Option<&str>, value: u64) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn set_pointer(&self, name: Option<&str>, value: *const c_void) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn set_string_str(&self, name: Option<&str>, string: Option<&str>) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn set_string_string(&self, name: Option<&str>, string: *const c_void) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn set_float(&self, name: Option<&str>, value: c_float) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn set_double(&self, name: Option<&str>, value: c_double) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn set_alignment(&self, name: Option<&str>, value: *const c_void) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn set_point<P: PointMethods>(&self, name: Option<&str>, value: &P) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn set_rect<R: RectMethods>(&self, name: Option<&str>, value: &R) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,
    ...
    fn set_size<S: SizeMethods>(&self, name: Option<&str>, value: &S) -> status_t {
        unsafe {
            let name = match name {
                Some(s) => Some(CString::from_vec_unchecked(s.into())),
                None => None,

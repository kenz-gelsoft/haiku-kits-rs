...
extern "C" {
    ...
    // NOT_SUPPORTED: pub fn BMessage_AddInt8(self_: *mut c_void, name: *const c_char, value: int8) -> status_t;
    // NOT_SUPPORTED: pub fn BMessage_AddUInt8(self_: *mut c_void, name: *const c_char, value: uint8) -> status_t;
    // NOT_SUPPORTED: pub fn BMessage_AddInt16(self_: *mut c_void, name: *const c_char, value: int16) -> status_t;
    // NOT_SUPPORTED: pub fn BMessage_AddUInt16(self_: *mut c_void, name: *const c_char, value: uint16) -> status_t;
    ...
    // NOT_SUPPORTED: pub fn BMessage_AddInt64(self_: *mut c_void, name: *const c_char, value: int64) -> status_t;
    // NOT_SUPPORTED: pub fn BMessage_AddUInt64(self_: *mut c_void, name: *const c_char, value: uint64) -> status_t;
    ...
    // NOT_SUPPORTED: pub fn BMessage_ReplaceInt8(self_: *mut c_void, name: *const c_char, value: int8) -> status_t;
    // NOT_SUPPORTED: pub fn BMessage_ReplaceInt81(self_: *mut c_void, name: *const c_char, index: i32, value: int8) -> status_t;
    // NOT_SUPPORTED: pub fn BMessage_ReplaceUInt8(self_: *mut c_void, name: *const c_char, value: uint8) -> status_t;
    // NOT_SUPPORTED: pub fn BMessage_ReplaceUInt81(self_: *mut c_void, name: *const c_char, index: i32, value: uint8) -> status_t;
    // NOT_SUPPORTED: pub fn BMessage_ReplaceInt16(self_: *mut c_void, name: *const c_char, value: int16) -> status_t;
    // NOT_SUPPORTED: pub fn BMessage_ReplaceInt161(self_: *mut c_void, name: *const c_char, index: i32, value: int16) -> status_t;
    // NOT_SUPPORTED: pub fn BMessage_ReplaceUInt16(self_: *mut c_void, name: *const c_char, value: uint16) -> status_t;
    // NOT_SUPPORTED: pub fn BMessage_ReplaceUInt161(self_: *mut c_void, name: *const c_char, index: i32, value: uint16) -> status_t;
    ...
    // NOT_SUPPORTED: pub fn BMessage_ReplaceInt64(self_: *mut c_void, name: *const c_char, value: int64) -> status_t;
    // NOT_SUPPORTED: pub fn BMessage_ReplaceInt641(self_: *mut c_void, name: *const c_char, index: i32, value: int64) -> status_t;
    // NOT_SUPPORTED: pub fn BMessage_ReplaceUInt64(self_: *mut c_void, name: *const c_char, value: uint64) -> status_t;
    // NOT_SUPPORTED: pub fn BMessage_ReplaceUInt641(self_: *mut c_void, name: *const c_char, index: i32, value: uint64) -> status_t;
    ...
    // NOT_SUPPORTED: pub fn BMessage_FindInt82(self_: *const c_void, name: *const c_char, n: i32) -> int8;
    // NOT_SUPPORTED: pub fn BMessage_FindInt162(self_: *const c_void, name: *const c_char, n: i32) -> int16;
    // BLOCKED: pub fn BMessage_FindInt322(self_: *const c_void, name: *const c_char, n: i32) -> i32;
    // NOT_SUPPORTED: pub fn BMessage_FindInt642(self_: *const c_void, name: *const c_char, n: i32) -> int64;
    ...
    // NOT_SUPPORTED: pub fn BMessage_GetInt8(self_: *const c_void, name: *const c_char, default_value: int8) -> int8;
    // NOT_SUPPORTED: pub fn BMessage_GetInt81(self_: *const c_void, name: *const c_char, index: i32, default_value: int8) -> int8;
    // NOT_SUPPORTED: pub fn BMessage_GetUInt8(self_: *const c_void, name: *const c_char, default_value: uint8) -> uint8;
    // NOT_SUPPORTED: pub fn BMessage_GetUInt81(self_: *const c_void, name: *const c_char, index: i32, default_value: uint8) -> uint8;
    // NOT_SUPPORTED: pub fn BMessage_GetInt16(self_: *const c_void, name: *const c_char, default_value: int16) -> int16;
    // NOT_SUPPORTED: pub fn BMessage_GetInt161(self_: *const c_void, name: *const c_char, index: i32, default_value: int16) -> int16;
    // NOT_SUPPORTED: pub fn BMessage_GetUInt16(self_: *const c_void, name: *const c_char, default_value: uint16) -> uint16;
    // NOT_SUPPORTED: pub fn BMessage_GetUInt161(self_: *const c_void, name: *const c_char, index: i32, default_value: uint16) -> uint16;
    ...
    // NOT_SUPPORTED: pub fn BMessage_GetInt64(self_: *const c_void, name: *const c_char, default_value: int64) -> int64;
    // NOT_SUPPORTED: pub fn BMessage_GetInt641(self_: *const c_void, name: *const c_char, index: i32, default_value: int64) -> int64;
    // NOT_SUPPORTED: pub fn BMessage_GetUInt64(self_: *const c_void, name: *const c_char, default_value: uint64) -> uint64;
    // NOT_SUPPORTED: pub fn BMessage_GetUInt641(self_: *const c_void, name: *const c_char, index: i32, default_value: uint64) -> uint64;
    ...
    // NOT_SUPPORTED: pub fn BMessage_SetInt8(self_: *mut c_void, name: *const c_char, value: int8) -> status_t;
    // NOT_SUPPORTED: pub fn BMessage_SetUInt8(self_: *mut c_void, name: *const c_char, value: uint8) -> status_t;
    // NOT_SUPPORTED: pub fn BMessage_SetInt16(self_: *mut c_void, name: *const c_char, value: int16) -> status_t;
    // NOT_SUPPORTED: pub fn BMessage_SetUInt16(self_: *mut c_void, name: *const c_char, value: uint16) -> status_t;
    ...
    // NOT_SUPPORTED: pub fn BMessage_SetInt64(self_: *mut c_void, name: *const c_char, value: int64) -> status_t;
    // NOT_SUPPORTED: pub fn BMessage_SetUInt64(self_: *mut c_void, name: *const c_char, value: uint64) -> status_t;

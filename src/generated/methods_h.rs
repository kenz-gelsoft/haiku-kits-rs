...
pub trait HandlerMethods: rchivableMethods {
    ...
    ///
    /// See [C++ `BHandler::Looper()`'s documentation](url/to/classBHandler#ac8e949959b12e602e3b0c4f023c60e6c).
    ...
    ///
    /// See [C++ `BHandler::SetName()`'s documentation](url/to/classBHandler#abf861126df4b6e71b9261a99da4ad0eb).
    fn set_name(&self, name: *const c_void) {
        unsafe { ffi::BHandler_SetName(self.as_ptr(), name) }
    }
    /// Return the name of this handler.
    ///
    /// See [C++ `BHandler::Name()`'s documentation](url/to/classBHandler#a40b246ac272e09b2f641d1290be21200).
    ...
    ///
    /// See [C++ `BHandler::SetNextHandler()`'s documentation](url/to/classBHandler#a02f78779c8141987d6030e73c22e734a).
    ...
    ///
    /// See [C++ `BHandler::NextHandler()`'s documentation](url/to/classBHandler#a92855d8f88f6072e7225bde292feaa38).
    ...
    ///
    /// See [C++ `BHandler::AddFilter()`'s documentation](url/to/classBHandler#a862bea548363faac6f883b348cbed838).
    fn add_filter(&self, filter: *mut c_void) {
        unsafe { ffi::BHandler_AddFilter(self.as_ptr(), filter) }
    }
    /// Remove filter from the filter list.
    ///
    /// See [C++ `BHandler::RemoveFilter()`'s documentation](url/to/classBHandler#a2b608135b27f283802648e7c6f8cdc83).
    ...
    ///
    /// See [C++ `BHandler::SetFilterList()`'s documentation](url/to/classBHandler#a503344dc801858e1f5f419be3919e9cf).
    ...
    ///
    /// See [C++ `BHandler::FilterList()`'s documentation](url/to/classBHandler#a909662a049856f6863a934cf18161554).
    fn filter_list(&self) -> *mut c_void {
        unsafe { ffi::BHandler_FilterList(self.as_ptr()) }
    }
    /// Lock the looper associated with this handler.
    ///
    /// See [C++ `BHandler::LockLooper()`'s documentation](url/to/classBHandler#a9d64bf66b4914918e24390d117e83477).
    ...
    /// Unlock the looper.
    ///
    /// See [C++ `BHandler::UnlockLooper()`'s documentation](url/to/classBHandler#ab131af7eb7aa2b9eea3a11ac1bfd4c03).
    ...
    ///
    /// See [C++ `BHandler::IsWatched()`'s documentation](url/to/classBHandler#a581b84f0f067afa88768ce6a0c07f59f).

...
wxwidgets! {
    ...
    /// - See [C++ `BApplication` class's documentation](url/to/classBApplication) for more details.
...
impl<const FROM_CPP: bool> ApplicationFromCpp<FROM_CPP> {
    ...
    ///
    /// See [C++ `BApplication::BApplication()`'s documentation](url/to/classBApplication#ae76219f7c7c91b14739e94c608f7349c).
    ...
    ///
    /// See [C++ `BApplication::BApplication()`'s documentation](url/to/classBApplication#a43b0671b327a0883720c6cc18d908149).
    ...
    ///
    /// See [C++ `BApplication::BApplication()`'s documentation](url/to/classBApplication#a998f767f4ddcbb5588455c8b63e08f74).
...
impl<const FROM_CPP: bool> ArchivableMethods for ApplicationFromCpp<FROM_CPP> {
    ...
    ///
    /// See [C++ `BApplication::Instantiate()`'s documentation](url/to/classBApplication#aa2814aceefbe18ac62814157f53a07c0).
...
wxwidgets! {
    ...
    /// - See [C++ `BArchivable` class's documentation](url/to/classBArchivable) for more details.
...
impl<const FROM_CPP: bool> ArchivableFromCpp<FROM_CPP> {
    ...
    ///
    /// See [C++ `BArchivable::BArchivable()`'s documentation](url/to/classBArchivable#a66e6b947f092d32f287913a8c253290f).
    pub fn new() -> ArchivableFromCpp<FROM_CPP> {
        unsafe { ArchivableFromCpp(ffi::BArchivable_new()) }
    }
    /// Constructor. Does important behind-the-scenes work in the unarchiving process.
    ///
    /// See [C++ `BArchivable::BArchivable()`'s documentation](url/to/classBArchivable#aed4f0566f9659b03912a859077c27c89).

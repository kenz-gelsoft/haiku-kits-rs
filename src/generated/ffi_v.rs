...
extern "C" {
    ...
    // NOT_SUPPORTED: pub fn BView_SetViewUIColor(self_: *mut c_void, which: color_which, tint: c_float);
    // NOT_SUPPORTED: pub fn BView_ViewUIColor(self_: *const c_void, tint: *mut c_void) -> color_which;
    ...
    // NOT_SUPPORTED: pub fn BView_SetHighUIColor(self_: *mut c_void, which: color_which, tint: c_float);
    // NOT_SUPPORTED: pub fn BView_HighUIColor(self_: *const c_void, tint: *mut c_void) -> color_which;
    ...
    // NOT_SUPPORTED: pub fn BView_SetLowUIColor(self_: *mut c_void, which: color_which, tint: c_float);
    // NOT_SUPPORTED: pub fn BView_LowUIColor(self_: *const c_void, tint: *mut c_void) -> color_which;

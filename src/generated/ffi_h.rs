...
extern "C" {
    ...
    // BHandler
    pub fn BHandler_dynamic_cast(ptr: *mut c_void) -> *mut c_void;
    ...
    pub fn BHandler_SetName(self_: *mut c_void, name: *const c_char);
    pub fn BHandler_Name(self_: *const c_void) -> *const c_char;
    ...
    pub fn BHandler_new1(name: *const c_char) -> *mut c_void;

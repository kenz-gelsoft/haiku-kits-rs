...
extern "C" {
    ...
    pub fn BHandler_LockLooperWithTimeout(self_: *mut c_void, timeout: i64) -> i32;
    ...
    pub fn BHandler_GetSupportedSuites(self_: *mut c_void, data: *mut c_void) -> i32;
    // NOT_SUPPORTED: pub fn BHandler_StartWatching(self_: *mut c_void, target: BMessenger, what: uint32) -> i32;
    // NOT_SUPPORTED: pub fn BHandler_StartWatchingAll(self_: *mut c_void, target: BMessenger) -> i32;
    // NOT_SUPPORTED: pub fn BHandler_StopWatching(self_: *mut c_void, target: BMessenger, what: uint32) -> i32;
    // NOT_SUPPORTED: pub fn BHandler_StopWatchingAll(self_: *mut c_void, target: BMessenger) -> i32;
    // NOT_SUPPORTED: pub fn BHandler_StartWatching1(self_: *mut c_void, observer: *mut c_void, what: uint32) -> i32;
    pub fn BHandler_StartWatchingAll1(self_: *mut c_void, observer: *mut c_void) -> i32;
    // NOT_SUPPORTED: pub fn BHandler_StopWatching1(self_: *mut c_void, observer: *mut c_void, what: uint32) -> i32;
    pub fn BHandler_StopWatchingAll1(self_: *mut c_void, observer: *mut c_void) -> i32;

...
extern "C" {
    ...
    // NOT_SUPPORTED: pub fn BHandler_StartWatching(self_: *mut c_void, target: BMessenger, what: u32) -> i32;
    // NOT_SUPPORTED: pub fn BHandler_StartWatchingAll(self_: *mut c_void, target: BMessenger) -> i32;
    // NOT_SUPPORTED: pub fn BHandler_StopWatching(self_: *mut c_void, target: BMessenger, what: u32) -> i32;
    // NOT_SUPPORTED: pub fn BHandler_StopWatchingAll(self_: *mut c_void, target: BMessenger) -> i32;
    pub fn BHandler_StartWatching1(self_: *mut c_void, observer: *mut c_void, what: u32) -> i32;
    pub fn BHandler_StartWatchingAll1(self_: *mut c_void, observer: *mut c_void) -> i32;
    pub fn BHandler_StopWatching1(self_: *mut c_void, observer: *mut c_void, what: u32) -> i32;

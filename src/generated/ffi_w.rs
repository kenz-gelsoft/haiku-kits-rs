...
extern "C" {
    ...
    // NOT_SUPPORTED: pub fn BWindow_new1(frame: *mut c_void, title: *const c_char, look: window_look, feel: window_feel, flags: u32, workspace: u32) -> *mut c_void;
    // NOT_SUPPORTED: pub fn BWindow_new2(frame: *mut c_void, title: *const c_char, type_: window_type, flags: u32, workspace: u32) -> *mut c_void;

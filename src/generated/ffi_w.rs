...
extern "C" {
    ...
    // NOT_SUPPORTED: pub fn BWindow_new1(frame: BRect, title: *const c_char, look: window_look, feel: window_feel, flags: u32, workspace: u32) -> *mut c_void;
    // NOT_SUPPORTED: pub fn BWindow_new2(frame: BRect, title: *const c_char, type_: window_type, flags: u32, workspace: u32) -> *mut c_void;
    ...
    // NOT_SUPPORTED: pub fn BWindow_Bounds(self_: *const c_void) -> BRect;
    pub fn BWindow_CenterIn(self_: *mut c_void, rect: *const c_void);
    pub fn BWindow_CenterOnScreen(self_: *mut c_void);
    // NOT_SUPPORTED: pub fn BWindow_CenterOnScreen1(self_: *mut c_void, id: screen_id);
    ...
    // NOT_SUPPORTED: pub fn BWindow_DecoratorFrame(self_: *const c_void) -> BRect;
    ...
    // NOT_SUPPORTED: pub fn BWindow_Look(self_: *const c_void) -> window_look;
    ...
    // NOT_SUPPORTED: pub fn BWindow_SetFeel(self_: *mut c_void, feel: window_feel) -> status_t;

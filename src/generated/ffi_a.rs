...
extern "C" {
    ...
    // NOT_SUPPORTED: pub fn BApplication_RegisterLooper(self_: *mut c_void, looper: *mut c_void) -> status_t;
    // NOT_SUPPORTED: pub fn BApplication_UnregisterLooper(self_: *mut c_void, looper: *mut c_void) -> status_t;
    ...
    // NOT_SUPPORTED: pub fn BApplication_InitCheck(self_: *const c_void) -> status_t;
    ...
    // NOT_SUPPORTED: pub fn BArchivable_AllArchived(self_: *const c_void, archive: *mut c_void) -> status_t;
    // NOT_SUPPORTED: pub fn BArchivable_AllUnarchived(self_: *mut c_void, archive: *const c_void) -> status_t;
    // NOT_SUPPORTED: pub fn BArchivable_Archive(self_: *const c_void, into: *mut c_void, deep: bool) -> status_t;
    // NOT_SUPPORTED: pub fn BArchivable_Perform(self_: *mut c_void, d: perform_code, arg: *mut c_void) -> status_t;

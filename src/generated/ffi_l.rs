...
extern "C" {
    ...
    // BLooper
    pub fn BLooper_delete(self_: *mut c_void);
    ...
    pub fn BLooper_Run(self_: *mut c_void) -> thread_id;
    ...
    pub fn BLooper_LockWithTimeout(self_: *mut c_void, timeout: bigtime_t) -> status_t;
    pub fn BLooper_Thread(self_: *const c_void) -> thread_id;
    pub fn BLooper_Team(self_: *const c_void) -> team_id;
    pub fn BLooper_LooperForThread(thread: thread_id) -> *mut c_void;
    pub fn BLooper_LockingThread(self_: *const c_void) -> thread_id;
    pub fn BLooper_CountLocks(self_: *const c_void) -> i32;
    pub fn BLooper_CountLockRequests(self_: *const c_void) -> i32;
    pub fn BLooper_Sem(self_: *const c_void) -> sem_id;
